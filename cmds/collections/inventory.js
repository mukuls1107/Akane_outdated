...
module.exports.run = async (bot, message, args) => {
    ...
    if(!inventory){
        ...
        return message.reply(`Welcome to Akane! You got a free extra **Sleeve**, use Sleeves to catch characters you want, you get Sleeves by either using 'claim' every 3 hours or grabbing them when they randomly drop. You can now start using 'claim' to get your Sleeves and 'spawn' to spawn a random character, object or event. Good Luck!`)    
    }
    ...
    let embed = new Discord.RichEmbed()
        ...
        .addField(`<:Gold:880095788552843355> Sleeves:`,`${inventory.get('sleeves')}`, true)
        .addField(`<a:ax_Bow:880095051814953031> Haru Sleeves:`,`${inventory.get('goldSleeves')}`, true)

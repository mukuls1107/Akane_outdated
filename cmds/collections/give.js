...
module.exports.run = async (bot, message, args) => {
    ...
    collectorSend.on('collect', async (reaction, reactionCollector) => {
        ...
        if(!giftedUser){
            ...
            await newUser.save();
            message.channel.send(`**${gifted}**, Welcome to **Akane**! You got a free extra **Sleeve**, use Sleeves to catch characters you want, you get Sleeves by either using 'claim' every 3 hours or grabbing them when they randomly drop. You can now start using 'claim' to get your Sleeves and 'spawn' to spawn a random character, object or event. Good Luck!`)
        }

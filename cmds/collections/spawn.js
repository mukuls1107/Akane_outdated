...
module.exports.run = async (bot, message, args) => {
    ...
    if(!user){
        ...
        await newUser.save();
        return message.reply(`Welcome to **Akane**! You got a free extra **Sleeve**, use Sleeves to catch characters you want, you get Sleeves by either using 'get' every 3 hours or grabbing them when they randomly drop. You can now start using 'get' to get your Sleeves and 'spawn' to spawn a random character, object or event. Good Luck!`)
    }
    ...
    // Set icons for sex
    let male = "<:husbando:880302869042049034>";
    let female = "<:bc_c_02yay:879971713209749535>";
    // NEED TO ADD ICONS FOR BOTH AND OTHER
    let both = "<:husbando:880302869042049034><:bc_c_02yay:879971713209749535>";
    let unknown = "❔";
    let sexIcon = "";
    ...
    let embed = new Discord.RichEmbed()        
        ...
        .setTitle(`Name: **${name} ${sexIcon}**`)
        .setDescription(`Franchise: **${franch}**\nCategory: **${categoryName}**\nDesc: ${description}`)
...
async function addCharacterToInventory(bot, message, char, userClick, golden){
    ...
    if(!user){
        ...
        await newUser.save();
        user = await bot.userinventories.findOne({ userID: userClick.id });
        message.channel.send(`${userClick}, Welcome to **Akane**! You got a free extra **Sleeve**, use Sleeves to catch characters you want, you get Sleeves by either using 'get' every 3 hours or grabbing them when they randomly drop. You can now start using 'get' to get your Sleeves and 'spawn' to spawn a random character, object or event. Good Luck!`);
    }

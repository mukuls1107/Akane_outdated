...
module.exports.run = async (bot, message, args) => {
    ...
    let help = `Usage: ${bot.prefix}Gandhi <text> | to make Gandhi say a quote\n${bot.prefix}gandhi <text>;<name> | to make Gandhi say a quote but change the name\n`
    ...
    // Get image
    let img = `./assets/gmedits/test/Gandhi${message.author.id}.jpg`;
    let image = `./assets/images/Gandhi.jpg`;
    // Image configuration
